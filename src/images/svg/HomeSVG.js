...
export let Tower = props => {
    let date = new Date()
    let milliseconds = Math.floor(date.getMilliseconds())
    let seconds = date.getSeconds()
    return (
        <React.Fragment>
            <mask id={props.id}>
                ...
                <rect x={props.x + 100 -12.5} y="-500" width="25" height="1000" fill="black"/>
                <rect x={props.x + 250 -12.5} y="-500" width="25" height="1000" fill="black"/>
            </mask>
            {seconds % 2 === 0 ? <line x1={props.x + 175} x2={props.x + 175} y1={-100 + milliseconds / 2} y2={milliseconds / 2} strokeWidth={10} stroke="purple" /> : <line x1={props.x + 175} x2={props.x + 175} y1={400 - milliseconds / 2} y2={300 - milliseconds / 2} strokeWidth={10} stroke="indigo" />}
            {seconds % 2 === 0 ? <line x1={40 + props.x + 175} x2={40 + props.x + 175} y1={-25 + milliseconds / 2} y2={-75 + milliseconds / 2} strokeWidth={10} stroke="#ff5e6d" /> : <line x1={40 + props.x + 175} x2={40 + props.x + 175} y1={325 - milliseconds / 2} y2={375 - milliseconds / 2} strokeWidth={10} stroke="pink" />}
            {seconds % 2 === 0 ? <line x1={-20 + props.x + 175} x2={-20 + props.x + 175} y1={-100 + milliseconds / 2} y2={milliseconds / 2} strokeWidth={10} stroke="#ff5e6d" /> : <line x1={-20 + props.x + 175} x2={-20 + props.x + 175} y1={400 - milliseconds / 2} y2={300 - milliseconds / 2} strokeWidth={10} stroke="pink" />}
            {seconds % 2 === 0 ? <line x1={20 + props.x + 175} x2={20 + props.x + 175} y1={-100 + milliseconds / 2} y2={milliseconds / 2} strokeWidth={10} stroke="#ff5e6d" /> : <line x1={20 + props.x + 175} x2={20 + props.x + 175} y1={400 - milliseconds / 2} y2={300 - milliseconds / 2} strokeWidth={10} stroke="pink" />}
            {seconds % 2 === 0 ? <line x1={-40 + props.x + 175} x2={-40 + props.x + 175} y1={-25 + milliseconds / 2} y2={-75 + milliseconds / 2} strokeWidth={10} stroke="#ff5e6d" /> : <line x1={-40 + props.x + 175} x2={-40 + props.x + 175} y1={325 - milliseconds / 2} y2={375 - milliseconds / 2} strokeWidth={10} stroke="pink" />}
